...
describe("Reveals and hides modal title, message and buttons", () => {
  describe('GIVEN that ModalTrigger is passed some example props and a text node', () => {
    beforeEach(() => {
  ...
  describe('GIVEN that ModalTrigger is passed some example props and a component node', () => {
    beforeEach(() => {
      ({ getByText, getByRole, container } = render(
        <ModalTrigger
          buttons={[
